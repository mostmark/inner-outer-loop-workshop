...
In the link:{CONSOLE_URL}/topology/ns/{DEV_PROJECT}[OpenShift Web Console^], `*click on the 'Home' menu, and choose 'Software Catalog'*`
...
%prod.quarkus.datasource.db-version=10.5
----
...
[source,shell,subs="attributes+",role=copypaste]
----
oc rsh -n {DEV_PROJECT} deploy/inventory-mariadb
----
...
[source,shell,subs="attributes+",role=copypaste]
----
oc rsh -n {DEV_PROJECT} deploy/catalog-postgresql
----
