...
image::coolstore-arch-inventory-quarkus.png[CoolStore Architecture,400,link=self,window=blank]
...
[sidebar]
--
image::quarkus-logo.png[Quarkus,500,link=self,window=blank]
...
image::inventory-quarkus-project.png[Inventory Project,500,link=self,window=blank]
...
|https://quarkus.io/guides/rest-json[JSON REST Services^]
|It allows you to develop REST services to consume and produce JSON payloads

|https://quarkus.io/guides/hibernate-orm[Hibernate ORM^]
|The de facto JPA implementation and offers you the full breadth of an Object Relational Mapper.

|https://quarkus.io/guides/datasource[Datasources (H2)^]
...
image::che-open-8080-link.png[Che - Open Link,500,link=self,window=blank]

You then have to confirm the access to external web sites:

image::vscode-external-website.png[Che - Open Link,500,link=self,window=blank]

Your browser will be directed to **your Inventory Service running inside your Workspace**.

image::che-quarkus-preview.png[Che - Quarkus Preview,500,link=self,window=blank]
...
If you are still seeing the following result in the browser window then it's likely your (Chromium)
browser is upgrading the simple *http://* based URL to *https* - but the inventory app doesn't support that.

image::inventory-quarkus-url-unavailable.png[Che - Preview Not Available,600,link=self,window=blank]

To fix this you need to `*click in the URL bar*` in the browser

image::inventory-quarkus-edit-url.png[Che - Preview Not Available,600,link=self,window=blank]

and `*remove that "s"*` making it *Not Secure* - like this:

image::inventory-quarkus-edited-url.png[Che - Preview Not Available,600,link=self,window=blank]
...
image::inventory-quarkus.png[Inventory Quarkus,500,link=self,window=blank]
...
Quarkus uses the JAX-RS standard for building REST services.
...
In your link:{WORKSPACE_URL}[Workspace^], stop the service as follows:
...
and *push* the .jar to OpenShift. The OpenShift https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/builds_using_buildconfig/understanding-image-builds[Source-to-Image (S2I)^] builder
...
----
[INFO] [io.quarkus...] STEP 3/9: ENV OPENSHIFT_BUILD_NAME="inventory-coolstore-1"     OPENSHIFT_BUILD_NAMESPACE="{DEV_PROJECT}"
...
[INFO] [io.quarkus....] COMMIT temp.builder.openshift.io/{DEV_PROJECT}/inventory-coolstore-1:2c2db764
[INFO] [io.quarkus....] Getting image source signatures
...
[INFO] [io.quarkus....] Successfully tagged temp.builder.openshift.io/{DEV_PROJECT}/inventory-coolstore-1:2c2db764
[INFO] [io.quarkus....]
[INFO] [io.quarkus....] Pushing image image-registry.openshift-image-registry.svc:5000/{DEV_PROJECT}/inventory-coolstore:1.0.0-SNAPSHOT ...
[INFO] [io.quarkus....] Getting image source signatures
...
[INFO] [io.quarkus....] Successfully pushed image-registry.openshift-image-registry.svc:5000/{DEV_PROJECT}/inventory-coolstore@sha256:be5b8ccdf161f4166ea0d040fcc78e1a09f8f20b16eb1b0d12ce288cd70c0643
[INFO] [io.quarkus....] Push successful
[INFO] [io.quarkus....] Deploying to openshift server: https://172.30.0.1:443/ in namespace: {DEV_PROJECT}.
[INFO] [io.quarkus....] Applied: ImageStream inventory-coolstore.
[INFO] [io.quarkus....] Applied: Deployment inventory-coolstore.
[INFO] [io.quarkus....] Applied: ImageStream openjdk-21.
...
[INFO] [io.quarkus....] The deployed application can be accessed at: http://inventory-coolstore-{DEV_PROJECT}.{OPENSHIFT_APPS_DOMAIN}
...
In the link:{CONSOLE_URL}/topology/ns/{DEV_PROJECT}[OpenShift Web Console^], `*click on the 'Open URL' icon of the Inventory Service*`

image::openshift-inventory-topology.png[OpenShift - Inventory Topology,700,link=self,window=blank]
